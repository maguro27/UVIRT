...
if __name__ == "__main__":
    ...
    for i in range(args.iter):
        ...
        fid_accumulation.append(fid_value)
        print("FID: ", fid_value)

    fid_mean = np.mean(fid_accumulation)
    fid_std = np.std(fid_accumulation)
    print("FID mean:{}".format(fid_mean))
    print("FID standard deviation:{}".format(fid_std))
